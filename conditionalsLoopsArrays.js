...
const roster = ['Pikachu', 'Mewto','Onix','Evee'];
...
const userPokemon = process.argv[2];
roster.push(userPokemon);
console.log(roster);

// ==================================================================
console.log("Challenge #3:");
// remove the item from the "roster" array that corresponds to 
// the user's second commanrd line argument
// NOTE: consider what data type command line arguments come in as
// console.log the "roster" array

const userRemovePokemon = process.argv[3];

for(let i = 0; i<roster.length;i++){
    if(userRemovePokemon == roster[i]){
        roster.splice(i,1);
    }
}
